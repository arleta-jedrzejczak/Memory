<template>
    <section id="skills" class="skills">
        ...
        <article>
            <p class="skills__description">Vestibulum mi enim, aliquam ut elementum id, bibendum eu dolor. Duis congue lectus eu diam auctor maximus. Donec eget pharetra purus. Cras at rhoncus ligula, dapibus dapibus ex. Phasellus varius tortor quis justo efficitur, vel cursus orci scelerisque. Aliquam facilisis est felis, eget eleifend libero tristique id. Etiam varius scelerisque consectetur. Suspendisse congue nisl at suscipit blandit.</p>
            <ul class="list-of-skills">
                <li class="list-of-skills__item">
